...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Create a nw bullet and add it to bullet group"""
    ...
    def _create_fleet(self):
        ...
        # Create an alien and find the numbers of alien in a row
    ...
    def _check_fleet_edges(self):
        """Respond appropriately if any aliens has reached the edge"""
